...
void Server::CheckProductStock(int server_socket) {
    ...
    for(int i = 0; i <= 1; i++) {
        ...
        string select_stock_query1 = "SELECT Stock FROM details where Fk_ProductID =  '"+ to_string(id_vector[random]) +"'  ";
...
// void Server::ShowDetails(int server_socket) {
//     string findbyid_query = "SELECT * FROM details";
