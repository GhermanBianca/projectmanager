...
void Server::InsertProperties(int server_socket, const string &prop_name, const string &prop_value, const string &product_fk) {
...
void Server::DisplayPropertyById(int server_socket, const string &propID) {
    string findbyid_query = "SELECT PropertyProductID, PropertyName, PropertyValue, Fk_PropertyProductID  FROM propertyproduct WHERE PropertyProductID = '" + propID +"' ";
